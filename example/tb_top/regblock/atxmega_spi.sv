...
module atxmega_spi (
    ...
    always_comb begin
        decoded_reg_strb.CTRL = cpuif_req_masked & (cpuif_addr == 4'h0);
        decoded_reg_strb.INTCTRL = cpuif_req_masked & (cpuif_addr == 4'h4);
        decoded_reg_strb.STATUS = cpuif_req_masked & (cpuif_addr == 4'h8);
        decoded_reg_strb.DATA = cpuif_req_masked & (cpuif_addr == 4'hc);
    end
    ...
    assign readback_array[3][15:8] = (decoded_reg_strb.DATA && !decoded_req_is_wr) ? hwif_in.DATA.RDATA.next : '0;
